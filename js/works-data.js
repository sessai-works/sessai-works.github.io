...
var DASHBOARD_DATA = {
  ...
  "projects": [
    ...
    },
    {
      ...
      "detail": {
        "overview": "旧版「社内営業プレリサーチ」の作り直し版。まず国の法人データ（gBizINFO）から同じ名前の会社を一覧にし、候補が複数なら人が1社を選ぶ（1社に決まったときも必ず1回確認する）。選んだ会社の公式サイトなどを読み、代表者名・設立・資本金などをまとめる。各項目には◎○△の印を機械が付け、どのページから取ったかを示す。売り手（自社）の商材の設定を差し替えれば、提案の切り口も変えられる。",
