...
var DASHBOARD_DATA = {
  ...
  "projects": [
    ...
    },
    {
      ...
      "detail": {
        "overview": "複数の外部サービスを1本の流れにつないだ運用自動化。①Googleドライブに置かれた動画を検出し、②Googleスプレッドシートで管理する投稿日・タイトル・説明文・ハッシュタグを読み取り、③YouTubeへ予約投稿し、④公開後に固定コメントを自動投稿、⑤再生数・視聴維持率・流入元といった実績をYouTubeから取得してスプレッドシートとデータファイルへ書き戻す。Windowsのタスクスケジューラで毎日2回、PCの前に人がいなくても動く。人が触るのは月1回だけ。",
        ...
        "impact": {
          ...
          "after": "投稿とコメントは全自動。人が触るのは月1回・約1分（APIで取得できない指標の転記のみ）",
